...
type RpcHead struct {
	...
	DestServerType SERVICE `protobuf:"varint,5,opt,name=DestServerType,proto3,enum=game.SERVICE" json:"DestServerType,omitempty"` //目标集群
	SendType       SEND    `protobuf:"varint,6,opt,name=SendType,proto3,enum=game.SEND" json:"SendType,omitempty"`
...
type ClusterInfo struct {
	...
	Type     SERVICE `protobuf:"varint,1,opt,name=Type,proto3,enum=game.SERVICE" json:"Type,omitempty"`
...
var file_rpc3_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x72, 0x70, 0x63, 0x33, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x67, 0x61,
	0x6d, 0x65, 0x22, 0xc6, 0x02, 0x0a, 0x07, 0x52, 0x70, 0x63, 0x48, 0x65, 0x61, 0x64, 0x12, 0x0e,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x2e, 0x53, 0x45, 0x52, 0x56,
	...
	0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x2e, 0x53, 0x45, 0x4e,
	...
	,
	...
	0x42, 0x4f, 0x41, 0x52, 0x44, 0x5f, 0x43, 0x41, 0x53, 0x54, 0x10, 0x02, 0x42, 0x09, 0x5a, 0x07,
	0x2e, 0x2e, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_rpc3_proto_goTypes = []interface{}{
	(SERVICE)(0),        // 0: game.SERVICE
	(SEND)(0),           // 1: game.SEND
	(*RpcHead)(nil),     // 2: game.RpcHead
	(*RpcPacket)(nil),   // 3: game.RpcPacket
	(*Packet)(nil),      // 4: game.Packet
	(*ClusterInfo)(nil), // 5: game.ClusterInfo
}
var file_rpc3_proto_depIdxs = []int32{
	0, // 0: game.RpcHead.DestServerType:type_name -> game.SERVICE
	1, // 1: game.RpcHead.SendType:type_name -> game.SEND
	2, // 2: game.RpcPacket.RpcHead:type_name -> game.RpcHead
	0, // 3: game.ClusterInfo.Type:type_name -> game.SERVICE
