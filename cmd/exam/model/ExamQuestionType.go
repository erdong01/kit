...
type ExamQuestionType struct {
	...
	ExamQuestionTypeScore                 float64 `json:"exam_question_type_score,omitempty"`
	ExamQuestionTypeActualScore           float64 `json:"exam_question_type_actual_score,omitempty"`
