...
type Question struct {
	...
	QuestionSmall        []QuestionSmall `gorm:"ForeignKey:QuestionNo;AssociationForeignKey:QuestionNo" json:"question_small,omitempty"`
	QuestionType         QuestionType    `gorm:"ForeignKey:QuestionTypeId;AssociationForeignKey:QuestionTypeId" json:"question_type,omitempty"`
}
