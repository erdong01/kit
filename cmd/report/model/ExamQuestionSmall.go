...
type ExamQuestionSmall struct {
	...
	ExamQuestionSmallScore       float32 `json:"exam_question_small_score,omitempty"`
	ExamQuestionSmallActualScore float32 `json:"exam_question_small_actual_score,omitempty"`
	ExamQuestionSmallIsRight     int8    `json:"exam_question_small_is_right,omitempty"`
	ExamQuestionSmallOrder       float32 `json:"exam_question_small_order,omitempty"`
