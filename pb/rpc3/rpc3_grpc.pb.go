...
func (UnimplementedTestServiceServer) TestSon(context.Context, *F) (*T, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestSon not implemented")
}
...
func _TestService_TestSon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(F)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServiceServer).TestSon(ctx, in)
	}
